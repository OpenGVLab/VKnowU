...
for dataset_name in ["videomme","vsibench","mmvu","mvbench"]:

    if args.repetition_penalty != 1.0:
        OUTPUT_PATH = f"./eval_results/eval_{dataset_name}/{args.mode}_{MODEL_PATH.replace('/', '_')}_Rp{args.repetition_penalty}.json"
    else:
